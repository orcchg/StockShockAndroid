package com.orcchg.yandexcontest.quotes.data

import com.orcchg.yandexcontest.core.network.api.WsSubscribeType
import com.orcchg.yandexcontest.coremodel.Quote
import com.orcchg.yandexcontest.quotes.data.remote.QuotesWebSocket
import com.orcchg.yandexcontest.quotes.data.remote.convert.WsQuoteNetworkConverter
...
class RealTimeStocksRepositoryImpl @Inject constructor(
    ...
    private val webSocketCloud: QuotesWebSocket,
